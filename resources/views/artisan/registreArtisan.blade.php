            ...
            <div class="grid grid-cols-6 h-full">
                <div class="bg-blue-900 p-10 col-span-2">
                    ...
                    <div class="bg-blue-50 p-14 col-span-4">
                        ...
                        <div class="mb-6">
                            <textarea class="w-full rounded-2xl placeholder:text-xs px-6 py-4 resize-none	m-t-2" placeholder="Votre description"
                                name="description" id="" rows="3"></textarea>
                        </div>
                        <div class="flex flex-col">
                        ...
                        <div class="flex flex-col">
                            ...
                            <select id="skills" name="skills[]" class="py-2 px-4 bg-white rounded-md border border-gray-300 mb-2" multiple>
                                <option value="" disabled selected>Select Your Skills</option>
                                @foreach ($competences as $competence)
                                    <option value="{{ $competence->id }}" data-job="{{ $competence->job->id }}">{{ $competence->name }}</option>
                                @endforeach
                            </select>
                        </div>
