        ...
        <div class="pt-4  h-screen  ">
                @if (session('success'))
                    <div id="success-message"
                        class="bg-green-500  fixed right-20  top-50 z-50 text-white p-4 text-center animate-bounce mb-4">
                        {{ session('success') }}
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900">First
                                name</label>
                            <div class="mt-2.5">
                                <input type="text" name="fname" id="first-name" autocomplete="given-name" value="{{$clientData ? $clientData->user->fname : ''}}"
                        ...
                        <div>
                            <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900">Last
                                name</label>
                            <div class="mt-2.5">
                                <input type="text" name="lname" id="last-name" autocomplete="family-name" value="{{$clientData ? $clientData->user->lname : ''}}"
                                    class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
