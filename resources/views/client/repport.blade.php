...
<body>
    <div class="flex flex-row h-screen ml-[1000px] ">
    @extends('layouts.ClientSideBar')
@section( 'content')
<div class="isolate bg-white sm:py-32 ">
    <div class="absolute inset-x-0 top-[-5rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]" aria-hidden="true">
