    ...
    <div class="p-16">
        ...
        <div class="p-8 bg-white shadow mt-24">
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                <div class="space-x-8 flex justify-between mt-32 md:mt-0 md:justify-center"> <form action="/Reserve" method="post"> @csrf <input type="hidden" value="{{$artisan->user->id}}" name="artisan_id"> <button
            ...
            <div class="mt-20 text-center border-b pb-12">
                ...
                <div class="flex gap-4  justify-center items-center">
                    <p class=" text-gray-600 mt-3 font-bold">City :  </p> <p class="font-light text-gray-600 mt-3">  {{ $artisan->user->city }}</p>
                </div>
            ...
            <div class="mt-12 flex flex-col justify-center">
                <p class="text-gray-600 text-center font-light lg:px-16">
                    A skilled bricoleur, Ryan, known by Melbourne roots and now based in Brooklyn as Nick Murphy, engages in the art of crafting, assembling, and recording all aspects of their music. This hands-on approach infuses their work with a distinct, intimate ambiance, complemented by a robust and rhythmic structure. Much like a bricoleur, Ryan is an artisan of considerable range, weaving together various elements to create a unique and compelling artistic tapestry.</p>
            </div>
        </div>
    </div>
</body>
